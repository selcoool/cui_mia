...
<head>
  ...
  <script>
    ...
    function updateTable() {
      var speed = document.getElementById("speedValue").innerText;
      var brightness = document.getElementById("brightnessValue").innerText;
      var ledBtnText = document.getElementById("ledStateBtn").innerText;
      var ledStatus = ledBtnText.includes("Tắt Đèn") ? "BẬT" : "TẮT";

      document.getElementById("infoSpeed").innerText = speed;
      document.getElementById("infoBrightness").innerText = brightness;
      document.getElementById("infoLED").innerText = ledStatus;
    }
  </script>
  <style>
...
<body onload="init()">
  ...
  <table>
    ...
    <tr>
      <td>Tốc độ (speed)</td>
      <td id="infoSpeed">100</td>
    </tr>
    <tr>
      <td>Độ sáng (brightness)</td>
      <td id="infoBrightness">127</td>
    </tr>
    <tr>
      <td>Trạng thái đèn LED</td>
      <td id="infoLED">TẮT</td>
    </tr>
  </table>
</body>
</html>
