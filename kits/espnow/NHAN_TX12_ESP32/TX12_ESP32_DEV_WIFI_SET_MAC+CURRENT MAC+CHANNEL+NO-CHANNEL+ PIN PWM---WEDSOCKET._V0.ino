...
void saveTrimValue(){
  ...
  prefs.putInt("TrimM1",M1_PIN);
 prefs.putInt("TrimM2",M2_PIN);
 prefs.putInt("TrimM3",M3_PIN);
 prefs.putInt("TrimM4",M4_PIN);
  prefs.end();
}
...
void loadTrimValue(){
  ...
  TrimM1=prefs.getInt("TrimM1",0);
  TrimM2=prefs.getInt("TrimM2",0);
  TrimM3=prefs.getInt("TrimM3",0);
  TrimM4=prefs.getInt("TrimM4",0);
  prefs.end();
}
...
<div class="card row">
  ...
  <div>
    ...
    <button onclick="saveI2C()">SAVE I2C</button>
  </div>
...
<button onclick="savePin()">APPLY</button> <button onclick="reset_memmory()">Reset Memmory</button>
