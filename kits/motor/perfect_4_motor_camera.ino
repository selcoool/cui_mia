  ...
  <body class="noselect" align="center" style="background-color:yellow">
    ...
    <table id="mainTable" style="width:400px;margin:auto;table-layout:fixed" CELLSPACING=10>
      ...
      <tr>
        ...
        <td class="button" ontouchstart='sendButtonInput("MoveCar","8")' ontouchend='sendButtonInput("MoveCar","8")'
        
        onmousedown='sendButtonInput("MoveCar","8")'
            onmouseup='sendButtonInput("MoveCar","8")'
        
        ><span class="arrows" >&#8679;</span></td>
        <td></td>
      </tr>
      <tr>
        <td class="button" ontouchstart='sendButtonInput("MoveCar","4")' ontouchend='sendButtonInput("MoveCar","4")'
            onmousedown='sendButtonInput("MoveCar","4")'
            onmouseup='sendButtonInput("MoveCar","4")'
        
        ><span class="arrows" >&#8678;</span></td>
        <td class="button" ontouchstart='sendButtonInput("MoveCar","5")' ontouchend='sendButtonInput("MoveCar","5")'
             onmousedown='sendButtonInput("MoveCar","5")'
            onmouseup='sendButtonInput("MoveCar","5")'
        
        ><span class="arrows">&#x1F6D1;</span></td> 
        <td class="button" ontouchstart='sendButtonInput("MoveCar","6")' ontouchend='sendButtonInput("MoveCar","6")'
        
          onmousedown='sendButtonInput("MoveCar","6")'
            onmouseup='sendButtonInput("MoveCar","6")'
        
        ><span class="arrows" >&#8680;</span></td>
      </tr>
      <tr>
        <td></td>
        <td class="button" ontouchstart='sendButtonInput("MoveCar","2")' ontouchend='sendButtonInput("MoveCar","2")'
           onmousedown='sendButtonInput("MoveCar","2")'
            onmouseup='sendButtonInput("MoveCar","2")'
  ...
  switch (type) 
  {
    ...
    case WS_EVT_DATA:
      ...
      if (info->final && info->index == 0 && info->len == len && info->opcode == WS_TEXT) 
      {
        ...
        //  Serial.printf("tyyyyyy");    
        //   Serial.printf(valueInt); 
        if (key == "MoveCar")
        {
          moveCar(valueInt);        
        }
        else if (key == "Speed")
        {
          // ledcWrite(PWMSpeedChannel, );
           ledcWrite(PWM_CHANNEL, valueInt);
        }
        else if (key == "Light")
        {
