...
A0: Joystick trái X – điều khiển Yaw (chưa dùng trong code này, bạn có thể thêm sau)

A1: Joystick trái Y – Throttle (tăng/giảm độ cao)

A2: Joystick phải X – Roll (nghiêng trái/phải)

A3: Joystick phải Y – Pitch (nghiêng trước/sau)
