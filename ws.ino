...
const char* ssid     = "D0806"; // Thay đổi tên Wi-Fi của bạn
const char* password = "INSIDESD0806"; // Thay đổi mật khẩu Wi-Fi của bạn

const char* websockets_server_host = "192.168.0.17"; // Địa chỉ IP của máy tính chạy WebSocket server
...
void loop() {
  if (client.available()) {
    ...
    client.sendBinary((const char*) fb->buf, fb->len); // Gửi hình ảnh dưới dạng nhị phân
